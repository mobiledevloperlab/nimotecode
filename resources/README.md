...
This directory is a small, maintained set of technical notes for developers who work away from a desk. It is intentionally not a product manual or a collection of generated keyword pages.

| Guide | Start here when you need to… |
| --- | --- |
| [Mobile development](mobile-development.md) | decide whether local, remote, or cloud development fits a task |
| [Android Linux development](android-linux-development.md) | compare Termux, PRoot, AVF, SSH, and cloud environments |
| [Remote development from a phone](remote-development-from-phone.md) | safely connect a phone to a real development host |
