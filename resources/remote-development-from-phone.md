...
NimoteCode keeps an SSH Explorer, editor, terminal, Git review, and AI assistance in a single mobile project context. See its [SSH workspace guide](https://nimotecode.com/docs/ssh) and the [SSH remote development example](../examples/ssh-remote-development/README.md).
